...
import { ArrowLeft, Loader2, AlertCircle, CheckCircle2, Mail, Sparkles } from "lucide-react";
          ...
          <div className="flex w-full flex-col justify-center bg-white px-8 py-10 md:w-[55%] md:px-12">
            {sent ? (
              ...
              >
                ...
                <Link
                  href="/login"
                  className="mt-8 rounded-2xl bg-gray-900 px-8 py-3.5 text-[15px] font-semibold text-white transition-all duration-300 hover:bg-gray-800 hover:shadow-lg"
                >
                  Back to Login
                </Link>
              </motion.div>
