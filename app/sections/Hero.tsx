      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="relative z-10">
            ...
            {/* Mobile marquee */}
            <div className="mb-6 md:hidden w-full flex items-center gap-2 overflow-hidden rounded-full border border-blue-200/80 bg-white/70 py-2 shadow-sm backdrop-blur">
