...
export default function ContactPage() {
  ...
  useEffect(() => {
    fetch('/api/content')
      .then((r) => r.json())
      .then((d) => { if (d?.data) setContactInfo((prev) => ({ ...prev, ...d.data })); })
      .catch(() => {});
  }, []);
          ...
          <div className="grid gap-6 lg:grid-cols-2 items-stretch">
            ...
            <ScrollReveal direction="right" delay={0.1}>
              <div className="relative overflow-hidden rounded-2xl border border-blue-500/20 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 p-6 text-white shadow-[0_24px_90px_rgba(2,6,23,0.22)] h-full flex flex-col sm:rounded-[2rem] sm:p-8">
                ...
                {status === "success" ? (
                  <div className="relative flex-1 flex flex-col items-center justify-center text-center gap-4 py-8">
                    <div className="rounded-full bg-emerald-500/15 p-4">
                      <CheckCircle2 className="h-10 w-10 text-emerald-400" />
                    </div>
                    <h2 className="text-2xl font-semibold text-white">Enquiry received!</h2>
                    ...
                    <button
                      ...
                      className="mt-2 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-400 to-cyan-400 px-6 py-3 text-sm font-semibold text-slate-950 transition hover:scale-[1.02] hover:shadow-lg"
                    >
                  ...
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="relative space-y-4 flex-1 flex flex-col">
